...
public class RSATest {
    ...
    public void generateRsaKey() {
        Map<String, String> map = RSAUtil.generateRasKey();
        System.out.println("随机生成的公钥为:" + map.get(RSAUtil.PUBLIC_KEY));
        System.out.println("随机生成的私钥为:" + map.get(RSAUtil.PRIVATE_KEY));
    ...
    public void testDecrypt() {
        String decrypt = RSAUtil.decrypt("Yeidauky/iN1/whevov2+ntzXJKAp2AHfESu5ixnDqH5iB7ww+TcfqJpDfkPHfb12Y0sVXw0gBHNJ4inkh7l2/SJBze3pKQU/mg3oyDokTia3JZIs+e80/iJcSfN+yA1JaqY+eJPYiBiOGAF2S6x0ynvJg/Wj0fwp2Tq3PDzRMo=", PRIVATE_KEY);
